      ...
      >
        ...
        {error && (
          <Alert
            ...
            description={error instanceof Error ? error.message : 'No se pudo cargar el detalle del pedido. Por favor, verifica la conexión con el servidor.'}
            type="error"
            showIcon
            action={
          ...
          <div>
            ...
            <Descriptions title="Dirección de Envío" bordered column={1} style={{ marginBottom: 24 }}>
              ...
              <Descriptions.Item label="Destinatario">
                {order.shippingAddress?.recipientName || 'No especificado'}
              </Descriptions.Item>
