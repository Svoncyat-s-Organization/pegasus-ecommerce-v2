...
DELETE FROM users WHERE email IN ('admin@pegasus.com', 'vendedor1@pegasus.com');
...
('vendedor1', 'vendedor1@pegasus.com', '$2a$12$H4ydi1ZIBLGlvzACtaf03OvENxxtiCELpooBFGt0UDsS/RLUbmNVi', 'DNI', '87654321', 'Carlos', 'Ramírez', '912345678', true);
