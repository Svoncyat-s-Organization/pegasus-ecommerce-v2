...
SELECT 'https://www.efe.com.pe/media/catalog/product/m/u/mu793bea.jpg', p.id, NULL, true, 0
FROM products p WHERE p.slug = 'iphone-15-pro';

INSERT INTO images (image_url, product_id, variant_id, is_primary, display_order)
SELECT 'https://movilcity.pe/cdn/shop/files/Samsung-Galaxy-S24-Ultra-1.webp', p.id, NULL, true, 0
FROM products p WHERE p.slug = 'galaxy-s24-ultra';
...
INSERT INTO images (image_url, product_id, variant_id, is_primary, display_order)
SELECT 'https://i5.walmartimages.com/seo/Dell-XPS-15-9520-Laptop.jpeg', p.id, NULL, true, 0
FROM products p WHERE p.slug = 'dell-xps-15';
