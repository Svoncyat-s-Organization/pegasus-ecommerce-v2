...
public record CreateSupplierRequest(
        @NotNull(message = "Tipo de documento es requerido") SupplierDocumentType docType,

        @NotBlank(message = "Número de documento es requerido") @Size(max = 20, message = "Número de documento no puede exceder 20 caracteres") String docNumber,

        @NotBlank(message = "Razón social es requerida") @Size(max = 150, message = "Razón social no puede exceder 150 caracteres") String companyName,
