...
public class RmaController {
        ...
        @PostMapping
        @Operation(summary = "Crear RMA", description = "Crear una nueva solicitud de devolución (RMA) desde backoffice usando una orden entregada")
        @ApiResponse(responseCode = "201", description = "RMA creado exitosamente")
        @ApiResponse(responseCode = "400", description = "Datos inválidos o la orden no está en estado válido")
        ...
        public ResponseEntity<RmaResponse> createRma(
                        ...
                        @RequestHeader(value = "X-User-Id", defaultValue = "1") Long staffUserId) {
                RmaResponse response = rmaService.createRma(request, staffUserId);
                return ResponseEntity.status(HttpStatus.CREATED).body(response);
        }

        @GetMapping
        @Operation(summary = "Listar RMAs", description = "Obtener todos los RMAs con paginación y filtros opcionales")
        ...
        @GetMapping("/{id}")
        @Operation(summary = "Obtener RMA por ID", description = "Obtener detalle completo de un RMA incluyendo items e historial")
        ...
        @Operation(summary = "Obtener RMA por número", description = "Buscar RMA por su número único (ej: RMA-2026-00001)")
        @ApiResponse(responseCode = "200", description = "RMA encontrado")
        @ApiResponse(responseCode = "404", description = "RMA no encontrado")
        ...
        @Operation(summary = "Obtener RMAs de un cliente", description = "Listar todas las devoluciones solicitadas por un cliente específico")
        @ApiResponse(responseCode = "200", description = "Lista obtenida exitosamente")
        ...
        @Operation(summary = "Obtener RMAs de una orden", description = "Listar todas las devoluciones asociadas a una orden específica")
        @ApiResponse(responseCode = "200", description = "Lista obtenida exitosamente")
        ...
        @PutMapping("/{id}")
        @Operation(summary = "Actualizar RMA", description = "Actualizar información de un RMA (solo staff)")
        ...
        public ResponseEntity<RmaResponse> updateRma(
                        ...
                        @RequestHeader(value = "X-User-Id", defaultValue = "1") Long userId // Mock: en producción viene
                                                                                            // del JWT
        ) {
        ...
        @Operation(summary = "Cancelar RMA", description = "Cancelar una solicitud de devolución (cliente o staff)")
        ...
        @Operation(summary = "Aprobar o rechazar RMA", description = "Staff aprueba o rechaza una solicitud de devolución")
        ...
        @Operation(summary = "Marcar RMA como en tránsito", description = "Staff registra que el cliente envió el paquete (pasa a IN_TRANSIT)")
        @ApiResponse(responseCode = "200", description = "RMA marcado como en tránsito")
        @ApiResponse(responseCode = "400", description = "RMA no está en estado APPROVED")
        @ApiResponse(responseCode = "404", description = "RMA no encontrado")
        public ResponseEntity<RmaResponse> markAsInTransit(
                        @PathVariable Long id,
                        @RequestParam(required = false) String comments,
                        @RequestHeader(value = "X-User-Id", defaultValue = "1") Long staffUserId) {
                RmaResponse response = rmaApprovalService.markAsInTransit(id, comments, staffUserId);
                return ResponseEntity.ok(response);
        }

        @PostMapping("/{id}/mark-received")
        @Operation(summary = "Marcar RMA como recibido", description = "Warehouse marca que recibió el paquete devuelto")
        ...
        @Operation(summary = "Inspeccionar item devuelto", description = "Staff inspecciona un item y evalúa su condición")
        ...
        @Operation(summary = "Obtener items sin inspeccionar", description = "Listar items de un RMA que aún no han sido inspeccionados")
        @ApiResponse(responseCode = "200", description = "Lista obtenida exitosamente")
        @ApiResponse(responseCode = "404", description = "RMA no encontrado")
        ...
        @Operation(summary = "Completar inspección", description = "Marcar que todos los items han sido inspeccionados")
        ...
        @Operation(summary = "Procesar reembolso", description = "Procesar el reembolso al cliente")
        ...
        @Operation(summary = "Cerrar RMA", description = "Cerrar RMA (restock items aprobados y finalizar proceso)")
        ...
        @Operation(summary = "RMAs pendientes de inspección", description = "Listar RMAs que han sido recibidos y esperan inspección")
        @ApiResponse(responseCode = "200", description = "Lista obtenida exitosamente")
        ...
        @Operation(summary = "RMAs listos para reembolso", description = "Listar RMAs inspeccionados que esperan procesamiento de reembolso")
        @ApiResponse(responseCode = "200", description = "Lista obtenida exitosamente")
