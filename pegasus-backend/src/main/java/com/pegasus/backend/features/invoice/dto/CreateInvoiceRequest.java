...
public record CreateInvoiceRequest(
        ...
        @Size(max = 20, message = "El documento del receptor no puede exceder 20 caracteres")
        String receiverTaxId,

        @NotBlank(message = "El nombre del receptor es requerido")
        @Size(max = 150, message = "El nombre del receptor no puede exceder 150 caracteres")
        String receiverName,

        @NotNull(message = "El subtotal es requerido")
        @DecimalMin(value = "0.00", inclusive = true, message = "El subtotal debe ser mayor o igual a 0")
        BigDecimal subtotal,

        @NotNull(message = "El IGV es requerido")
        @DecimalMin(value = "0.00", inclusive = true, message = "El IGV debe ser mayor o igual a 0")
        BigDecimal taxAmount,

        @NotNull(message = "El total es requerido")
        @DecimalMin(value = "0.01", inclusive = true, message = "El total debe ser mayor a 0")
