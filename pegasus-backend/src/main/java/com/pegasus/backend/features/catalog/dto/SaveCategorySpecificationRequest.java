...
/**
 * Request DTO for saving a CategorySpecification (used in batch operations)
 * Does not include categoryId as it's provided in the URL path
 */
@Data
public class SaveCategorySpecificationRequest {
