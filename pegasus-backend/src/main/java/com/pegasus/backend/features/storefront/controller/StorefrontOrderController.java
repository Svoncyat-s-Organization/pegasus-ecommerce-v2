...
public class StorefrontOrderController {
    ...
    @Operation(
            ...
            description = "Obtener detalle completo de un pedido del cliente autenticado"
    )
    ...
    @Operation(
            ...
            description = "Crear un nuevo pedido desde el storefront"
    )
    ...
    public ResponseEntity<OrderResponse> createOrder(
        ...
        OrderResponse response = orderService.createOrder(securedRequest, customerId);
    ...
    public ResponseEntity<OrderResponse> cancelMyOrder(
        ...
        OrderResponse response = orderService.cancelOrder(id, reason, customerId);
        return ResponseEntity.ok(response);
    }
}
